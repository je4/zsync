...
const (
	...
	// Group statements
	SQLLoadGroup                   = `SELECT version, created, modified, data, active, direction, tags, itemversion, collectionversion, tagversion, gitlab FROM groups g, syncgroups sg WHERE g.id = sg.id AND g.id = @id`
